...
<Content>
	<div class="grid w-full lg:w-fit grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
		...
		<dialog id="imageModal" class="modal p-4 bg-black bg-opacity-60 backdrop-blur-md">
			...
			>
				<button class="btn btn-square btn-sm md:btn-md bg-[#e24c4b] hover:bg-[#af3a3a] border-none rounded-2xl rounded-tl-none rounded-br-none absolute top-0 right-0 origin-top-right">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						class="h-5 w-5 md:h-6 md:w-6 stroke-white"
						fill="none"
						viewBox="0 0 24 24"
						stroke="currentColor"
						><path
